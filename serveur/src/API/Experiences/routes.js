...
import { create_Experiences_Details, create_List_Experiences, createAll_Experiences, update_Experience } from './controller';
const router = express.Router();

router.get('/get/experiences', asyncHandler(getListExperiences));
router.get('/get/experiences/:company', asyncHandler(getExperiencesByName));
