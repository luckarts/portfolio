...
module.exports = (sequelize, DataTypes) => {
  const Experience_detail = sequelize.define('Experience_detail', {
  ...
  Experience_detail.associate = function (models) {
    ...
    Experience_detail.hasMany(models.List_experience, { as: 'list_experience', foreignKey: 'experienceDetailId', targetKey: "id" });
