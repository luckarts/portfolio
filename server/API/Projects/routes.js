...
import { getAllProjects, getProjectByName,getProjectsByTag,getTechnos,create_Project, update_Project } from './controllers';
import { upload } from '../../helpers/multer/upload';
const router = express.Router();
import { jwtDecode } from '../../helpers/jwtDecode';

router.get('/get/projects', asyncHandler(getAllProjects));
router.get('/get/projects/tags', asyncHandler(getTechnos));
